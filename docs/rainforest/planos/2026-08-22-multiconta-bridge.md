...
### 10. O QR diz de qual conta ele e [tipo: implementar]
atende: D3, D4
arquivos: `whatsapp-bridge/main.go`, `whatsapp-bridge/main_test.go`, `whatsapp-mcp-server/whatsapp.py`, `whatsapp-mcp-server/main.py`, `whatsapp-mcp-server/test_account_routing.py`
depende de: 4, 6
paralela: nao
